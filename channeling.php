...
<head>
    ...
    <title>Online Doctor Channeling - Bloodline</title>
...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="nav-links">
            ...
            <a href="channeling.php" id="nav-home">Doctor Channeling</a>
    ...
    <!-- Online Doctor Channeling Section -->
    <div id="online-doctor-channeling" class="page-section">
        <h2>Online Doctor Channeling Service</h2>
        <p>Book your appointment with qualified doctors from the comfort of your home. Please fill out the form below to schedule your appointment.</p>
        ...
        <form action="submit_appointment.php" method="POST">
            ...
            <button type="submit" class="form-btn">Book Appointment<i class='bx bx-right-arrow-alt arrow'></i></button>
        </form>
    </div>
